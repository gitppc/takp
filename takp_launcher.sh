...
gdown40() {
	wget https://github.com/tanaikech/goodls/releases/download/v1.2.8/goodls_linux_amd64
	chmod +x goodls_linux_amd64
	./goodls_linux_amd64 -u https://drive.google.com/file/d/1X46DuXJYPl2igcwO2f5sHuX1XKX9BhVy/view -f TAKP.zip
	rm -rf goodls_linux_amd64
	mv TAKP.zip $HOME/.takp/cache/
}
...
install() {
	sudo apt install wine xdotool libvulkan1:i386 p7zip-full
	mkdir -p "${wine_prefix}"
